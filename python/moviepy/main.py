...
for meme in resp_json["memes"]:
    file_name = f'C:\\Users\\Keshav\\keshav_projects_4\\meme_video_generator\\memes\\{ meme["url"].split("/")[-1] }'
...
# moviepy work
background = VideoFileClip("C:\\Users\\Keshav\\keshav_projects_4\\meme_video_generator\\videos\\background.mp4").subclip(0,5)
...
if not sys.argv[1]:
    ...
    video_name = f"C:\\Users\\Keshav\\keshav_projects_4\\meme_video_generator\\videos\\{video_name}"
else:
